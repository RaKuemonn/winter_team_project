...
void Stage_4_Movement::update(const float elapsed_time)
{
...
bool Stage_4_Movement::ray_cast(const DirectX::XMFLOAT3& start, const DirectX::XMFLOAT3& end, Hit_Result* hit_result_)
{
