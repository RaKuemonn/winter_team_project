...
void Scene_Select::initialize(Scene_Manager* parent_)
{
    ...
    key_stage2 = make_unique<Sprite>(parent->device(), "Data/南京錠.png");
    key_stage3 = make_unique<Sprite>(parent->device(), "Data/南京錠.png");
    key_stage4 = make_unique<Sprite>(parent->device(), "Data/南京錠.png");
    key_boss = make_unique<Sprite>(parent->device(), "Data/南京錠.png");
