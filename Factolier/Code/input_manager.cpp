...
//  キー割り当ての設定
//--------------------------------------------------------------
void Input_Manager::setKeyAssign(int no, PadAssign* data)
{
...
//  ジョイスティック割り当ての設定
//--------------------------------------------------------------
void Input_Manager::setJoyAssign(int no, PadAssign* data)
{
...
Input_Manager::Input_Manager()
{
    ...
    // padをゼロクリアしておく
    SecureZeroMemory(pad, sizeof(PadState) * GAMEPAD_NUM);
...
//  マウスカーソルのx座標を取得
//--------------------------------------------------------------
int Input_Manager::getCursorPosX()
{
    return mousePos.x;
}
...
//  マウスカーソルのy座標を取得
//--------------------------------------------------------------
int Input_Manager::getCursorPosY()
{
    return mousePos.y;
}
