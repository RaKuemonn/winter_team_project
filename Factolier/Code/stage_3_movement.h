...
class Stage_3_Movement : public Stage
{
public:
    Stage_3_Movement(class Scene_Manager* ptr_scene_manager_, const DirectX::XMFLOAT3& position = {});
    ~Stage_3_Movement()override = default;
