...
Stage_3_Movement::Stage_3_Movement(Scene_Manager* ptr_scene_manager_, const DirectX::XMFLOAT3& position) : Stage(position)
{
    load_model(ptr_scene_manager_->model_manager()->load_model(Model_Paths::Stage::stage_3_propeller, true));
...
void Stage_3_Movement::update(const float elapsed_time)
{
...
bool Stage_3_Movement::ray_cast(const DirectX::XMFLOAT3& start, const DirectX::XMFLOAT3& end, Hit_Result* hit_result_)
{
