...
{
    create_vs_from_cso(device, "./CSO/fullscreen_quad_vs.cso", embedded_vertex_shader.ReleaseAndGetAddressOf(),
        nullptr, nullptr, 0);
    create_ps_from_cso(device, "./CSO/fullscreen_quad_ps.cso", embedded_pixel_shader.ReleaseAndGetAddressOf());
}
